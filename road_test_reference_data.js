window.ROAD_TEST_REFERENCE = {
  "version": "2026-04-11-roadtest-v6-road-driving-official",
  "sourcePriority": [
    "captions.sbv",
    "道路考試參考圖片轉文字檔案.txt"
  ],
  ...
  "notes": [
    "本版改以你上傳的「小型車駕駛人道路駕駛考驗評分基準及成績紀錄表」作為唯一主準。",
    "題目仍保留較貼近影片字幕的閱讀節奏，但每題的官方對齊、扣分條目與說明已改成道路駕駛考驗版本。",
    "口誦字句保留在獨立欄位；B柱、45度與教練路線提醒改放在提醒標籤或補充說明，不再當成官方主答案。",
    "檢查儀表統一整理為「檢查儀表（溫度、油量、煞車、充電、機油）作用」。",
    "非官方道路考驗核心的教練補充片段，已標為教練補充或排除出正式題庫。"
  ],
  "microSkills": [
    {
      "id": "left_signal",
  ...
  "segments": [
    {
      ...
      "officialStandards": [
        {
          "code": "D1-1",
          "label": "行車前檢查及起駛前動作｜上車前察看車輛四周、車底及輪胎有無異物（狀）",
          "deduction": 32,
          "page": 1
        }
      ],
      ...
      "examRelevant": true,
      "officialSourceLabel": "小型車駕駛人道路駕駛考驗評分基準及成績紀錄表 第1-2頁"
    },
    {
      "id": "road-seg-002",
      "bankId": "RT-002",
    ...
    },
    {
      ...
      "answerText": "上車前先觀察左右來車，再依二段式開門流程短開車門",
      "operationText": "上車前先觀察左右來車，再依二段式開門流程短開車門",
      ...
      "reminderNotes": [
        "正式評分主準是上車前注意人車通過；二段式開門在道路考驗終點下車時也會直接列為扣分項。"
      ],
      "startSec": 36.696,
      "endSec": 44.169,
      "clipLeadSeconds": 1.0,
      ...
      "officialStandards": [
        {
          "code": "D7-1",
          "label": "全程道路行駛｜上、下車開車門前未留意有無人車通過（下車應以2段式開門）",
          "deduction": 32,
          "page": 2
        },
        {
    ...
    },
    {
      ...
      "answerText": "車門先短開再複查左右安全，確認後再完成上車",
      "operationText": "車門先短開再複查左右安全，確認後再完成上車",
      "spokenText": "左右無來車",
      "spokenItems": [
        "左右無來車"
      ],
    ...
    },
    {
      ...
      "answerText": "起駛前調整座椅、椅背與頭枕",
      "operationText": "起駛前調整座椅、椅背與頭枕",
      ...
      "officialStandards": [
        {
          "code": "D1-2",
          "label": "行車前檢查及起駛前動作｜起駛前調整座椅、頭枕或照後鏡（受測人應口誦及動作檢查項目）",
          "deduction": 4,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "調整中央後照鏡、左右後照鏡並繫妥安全帶，確認P檔與手煞車",
      "operationText": "調整中央後照鏡、左右後照鏡並繫妥安全帶，確認P檔與手煞車",
      ...
      "officialStandards": [
        ...
        {
          "code": "D1-3",
          "label": "行車前檢查及起駛前動作｜未依規定繫安全帶",
          "deduction": 32,
          "page": 1
        },
        {
          "code": "D1-5",
          "label": "行車前檢查及起駛前動作｜自排車發動引擎未入P檔或未踩煞車",
          "deduction": 16,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "發動前確認自排車在P檔並踩住煞車，再轉動鑰匙至紅火",
      "operationText": "發動前確認自排車在P檔並踩住煞車，再轉動鑰匙至紅火",
      "spokenText": "開啟紅火",
      "spokenItems": [
        "開啟紅火"
      ],
    ...
    },
    {
      ...
      "officialStandards": [
        {
          "code": "D1-4",
          "label": "行車前檢查及起駛前動作｜起駛前未檢查儀表（溫度、油量、煞車、充電、機油）作用",
          "deduction": 4,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "踩住煞車發動引擎，確認儀表板顯示正常",
      "operationText": "踩住煞車發動引擎，確認儀表板顯示正常",
    ...
    },
    {
      ...
      "examRelevant": false,
      "officialSourceLabel": "小型車駕駛人道路駕駛考驗評分基準及成績紀錄表 第1-2頁（本段非官方核心）"
    },
    {
      "id": "road-seg-015",
      "bankId": "RT-014",
      ...
      "answerText": "起駛前鬆開手煞車並檢查煞車作用",
      "operationText": "起駛前鬆開手煞車並檢查煞車作用",
      ...
      "officialStandards": [
        {
          "code": "D1-6",
          "label": "行車前檢查及起駛前動作｜起駛前未鬆開手煞車及檢查煞車作用",
          "deduction": 16,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "確認左右方向燈作動正常",
      "operationText": "確認左右方向燈作動正常",
      ...
      "reminderNotes": [
        "試打方向燈是教練補充，正式扣分主準仍是起駛前與轉彎／變換車道前要正確顯示方向燈。"
      ],
      "startSec": 117.89,
      "endSec": 123.89,
      "clipLeadSeconds": 1.0,
      ...
      "officialStandards": [
        {
          "code": "D1-7",
          "label": "行車前檢查及起駛前動作｜起駛前未依規定顯示方向燈",
          "deduction": 32,
          "page": 1
        },
        {
          "code": "D5-4",
          "label": "車道行駛、變換車道、路口轉彎、迴車｜岔路轉彎、變換車道前，未依規定顯示方向燈及未轉頭察看照後鏡並注意車輛與行人路況",
          "deduction": 32,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "起駛前顯示左方向燈，入D檔、放手煞車準備起步",
      "operationText": "起駛前顯示左方向燈，入D檔、放手煞車準備起步",
    ...
    },
    {
      ...
      "answerText": "起駛前轉頭察看照後鏡並確認前後左右安全，再禮讓人車起步",
      "operationText": "起駛前轉頭察看照後鏡並確認前後左右安全，再禮讓人車起步",
      ...
      "officialStandards": [
        {
          "code": "D1-8",
          "label": "行車前檢查及起駛前動作｜起駛前未轉頭察看照後鏡並注意前後左右有無障礙或車輛行人",
          "deduction": 32,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "轉彎前依規定切換方向燈",
      "operationText": "轉彎前依規定切換方向燈",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [],
      "reminderNotes": [],
    ...
    },
    {
      ...
      "answerText": "接近路口先減速查看，預作隨時停車準備",
      "operationText": "接近路口先減速查看，預作隨時停車準備",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "intersection_scan"
      ...
      "officialStandards": [
        {
          "code": "D5-9",
          "label": "車道行駛、變換車道、路口轉彎、迴車｜行車速度控制不當，未減速慢行作隨時停車之準備",
          "deduction": 8,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "依考驗員指定路線行駛",
      "operationText": "依考驗員指定路線行駛",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "大門左側"
      ...
      "officialStandards": [
        {
          "code": "D5-8",
          "label": "車道行駛、變換車道、路口轉彎、迴車｜未依規定路線行駛或未依規定行駛正確車道",
          "deduction": 32,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "右轉完成後依規定切換左方向燈，準備後續車道操作",
      "operationText": "右轉完成後依規定切換左方向燈，準備後續車道操作",
      "spokenText": "左右無來車、後方無來車",
      "spokenItems": [
        "左右無來車、後方無來車"
      ],
    ...
    },
    {
      ...
      "answerText": "左轉前減速查看路口安全，左轉後依規定進入正確車道",
      "operationText": "左轉前減速查看路口安全，左轉後依規定進入正確車道",
      ...
      "reminderNotes": [
        "雙黃線提醒屬教練補充，正式主準對應的是不得跨越分向限制線與要走正確車道。"
      ],
      "startSec": 184.328,
      "endSec": 198.949,
      "clipLeadSeconds": 1.0,
    ...
    },
    {
      ...
      "answerText": "由快車道切換至慢車道前，顯示右方向燈並減速查看",
      "operationText": "由快車道切換至慢車道前，顯示右方向燈並減速查看",
    ...
    },
    {
      ...
      "answerText": "變換車道前轉頭察看照後鏡並確認側後方安全，再切入慢車道",
      "operationText": "變換車道前轉頭察看照後鏡並確認側後方安全，再切入慢車道",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "b_pillar",
      ...
      "reminderNotes": [
        "教練以「看到B柱」幫助你做出明顯轉頭動作；官方主準是轉頭察看照後鏡並注意車輛行人。"
      ],
      "startSec": 214.26,
      "endSec": 221.487,
      "clipLeadSeconds": 1.0,
    ...
    },
    {
      ...
      "answerText": "完成變換車道後，穩定行駛於正確車道",
      "operationText": "完成變換車道後，穩定行駛於正確車道",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "lane_change",
    ...
    },
    {
      ...
      "answerText": "靠邊停車前顯示右方向燈，並再次確認左右與後方安全",
      "operationText": "靠邊停車前顯示右方向燈，並再次確認左右與後方安全",
      ...
      "officialStandards": [
        {
          "code": "D4-3",
          "label": "路邊臨時停車｜靠邊停車前或起駛前，未依規定顯示方向燈或未轉頭察看照後鏡及注意有無障礙或車輛行人",
          "deduction": 32,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "靠邊停車前轉頭確認側後方安全，再讓車身靠近路面邊緣",
      "operationText": "靠邊停車前轉頭確認側後方安全，再讓車身靠近路面邊緣",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "b_pillar",
    ...
    },
    {
      ...
      "answerText": "路邊臨時停車時注意不可壓到路面邊線，並控制與邊緣距離",
      "operationText": "路邊臨時停車時注意不可壓到路面邊線，並控制與邊緣距離",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "邊線控制"
      ...
      "officialStandards": [
        {
          "code": "D4-4",
          "label": "路邊臨時停車｜臨時停車時右側前後輪胎外側距離緣石或路面邊緣逾六十公分",
          "deduction": 16,
          "page": 1
        },
        {
          "code": "D5-5",
          "label": "車道行駛、變換車道、路口轉彎、迴車｜行駛中車輪壓實線（分向限制線、快慢車道分隔線、禁止變換車道線或路面邊線）",
          "deduction": 32,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "再次靠邊停車前依規定顯示右方向燈",
      "operationText": "再次靠邊停車前依規定顯示右方向燈",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "right_signal"
    ...
    },
    {
      ...
      "answerText": "路邊臨時停車前減速查看並確認左右與後方安全",
      "operationText": "路邊臨時停車前減速查看並確認左右與後方安全",
    ...
    },
    {
      ...
      "answerText": "靠邊停車最後修正前，再次轉頭確認側後方安全",
      "operationText": "靠邊停車最後修正前，再次轉頭確認側後方安全",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "b_pillar",
    ...
    },
    {
      ...
      "answerText": "臨時停車後確認車輛已穩定停妥",
      "operationText": "臨時停車後確認車輛已穩定停妥",
      "spokenText": "打P檔、拉手煞車",
      "spokenItems": [
        "打P檔、拉手煞車"
      ],
      ...
      "reminderNotes": [
        "打P檔與拉手煞車是完成臨停的實務操作；官方臨停主準更重視安全觀察、紅線與距邊緣距離。"
      ],
      "startSec": 276.487,
      "endSec": 282.489,
      "clipLeadSeconds": 1.0,
    ...
    },
    {
      ...
      "answerText": "確認車輛不滑動後再保持煞車穩定",
      "operationText": "確認車輛不滑動後再保持煞車穩定",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [],
      "reminderNotes": [
        "此段屬實務操作補充，不是道路考驗評分表的明列核心。"
      ],
      "startSec": 282.489,
      "endSec": 285.312,
      "clipLeadSeconds": 1.0,
    ...
    },
    {
      ...
      "answerText": "確認路邊臨時停車已完成",
      "operationText": "確認路邊臨時停車已完成",
      "spokenText": "路邊臨時停車完畢",
      "spokenItems": [
        "路邊臨時停車完畢"
      ],
      ...
      "reminderNotes": [
        "此段為流程收束提醒，正式扣分仍以前方靠邊觀察、紅線、碰撞與距邊緣距離為主。"
      ],
      "startSec": 285.312,
      "endSec": 288.22,
      "clipLeadSeconds": 1.0,
    ...
    },
    {
      ...
      "answerText": "由路邊起駛前顯示左方向燈，入D檔、放手煞車並確認後方安全",
      "operationText": "由路邊起駛前顯示左方向燈，入D檔、放手煞車並確認後方安全",
      ...
      "officialStandards": [
        ...
        {
          "code": "D7-2",
          "label": "全程道路行駛｜起駛前未依規定顯示方向燈或未察看照後鏡並轉頭注意前後左右有無障礙或車輛行人",
          "deduction": 32,
          "page": 2
        }
      ],
    ...
    },
    {
      ...
      "answerText": "由路邊起駛前轉頭察看照後鏡並確認後方安全後再起步",
      "operationText": "由路邊起駛前轉頭察看照後鏡並確認後方安全後再起步",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "b_pillar",
    ...
    },
    {
      ...
      "answerText": "往左變換車道前顯示左方向燈並確認後方安全",
      "operationText": "往左變換車道前顯示左方向燈並確認後方安全",
    ...
    },
    {
      ...
      "answerText": "變換車道前轉頭察看照後鏡並確認側後方安全，再切入車道",
      "operationText": "變換車道前轉頭察看照後鏡並確認側後方安全，再切入車道",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "b_pillar",
    ...
    },
    {
      ...
      "answerText": "通過路口前先減速查看，確認安全後再通行",
      "operationText": "通過路口前先減速查看，確認安全後再通行",
      "spokenText": "左右無來車",
      "spokenItems": [
        "左右無來車"
      ],
    ...
    },
    {
      ...
      "answerText": "直線路段保持車身在車道內，注意照後鏡與車身位置",
      "operationText": "直線路段保持車身在車道內，注意照後鏡與車身位置",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "車道線控制"
    ...
    },
    {
      ...
      "answerText": "行駛中保持車身不壓線，持續留意車道線位置",
      "operationText": "行駛中保持車身不壓線，持續留意車道線位置",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "車道線控制"
    ...
    },
    {
      ...
      "answerText": "迴轉前依規定顯示左方向燈",
      "operationText": "迴轉前依規定顯示左方向燈",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "left_signal"
    ...
    },
    {
      ...
      "answerText": "迴轉前減速查看路口安全，預作隨時停車準備",
      "operationText": "迴轉前減速查看路口安全，預作隨時停車準備",
      "spokenText": "前方路口減速查看",
      "spokenItems": [
        "前方路口減速查看"
      ],
    ...
    },
    {
      ...
      "answerText": "迴轉前確認左右安全後，依序完成方向盤操作",
      "operationText": "迴轉前確認左右安全後，依序完成方向盤操作",
      "spokenText": "左右無來車",
      "spokenItems": [
        "左右無來車"
      ],
      ...
      "officialStandards": [
        ...
        {
          "code": "D5-7",
          "label": "車道行駛、變換車道、路口轉彎、迴車｜未遵守路權（含轉彎讓直行、圓環優先等）",
          "deduction": 16,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "迴轉後依規定行駛於正確車道",
      "operationText": "迴轉後依規定行駛於正確車道",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "u_turn",
    ...
    },
    {
      ...
      "answerText": "迴轉後持續保持車身在車道中央",
      "operationText": "迴轉後持續保持車身在車道中央",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "車道線控制"
    ...
    },
    {
      ...
      "answerText": "行駛中不可壓到任何實線或路面邊線",
      "operationText": "行駛中不可壓到任何實線或路面邊線",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "邊線控制",
    ...
    },
    {
      ...
      "answerText": "接近路口先減速查看，確認安全後再通行",
      "operationText": "接近路口先減速查看，確認安全後再通行",
      "spokenText": "前方路口減速查看／左右無來車",
      "spokenItems": [
        "前方路口減速查看",
        "左右無來車"
    ...
    },
    {
      ...
      "answerText": "一般道路行駛時平穩控制車速，接近路口前先減速",
      "operationText": "一般道路行駛時平穩控制車速，接近路口前先減速",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "速度控制"
    ...
    },
    {
      ...
      "answerText": "依速限與路況控制車速，不可因標示40就忽略前方路況",
      "operationText": "依速限與路況控制車速，不可因標示40就忽略前方路況",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "速度控制"
      ...
      "reminderNotes": [
        "教練口訣中的40～44公里是該場路線經驗值；正式主準是遇應減速路段要慢行並作隨時停車準備。"
      ],
      "startSec": 489.74,
      "endSec": 499.74,
      "clipLeadSeconds": 1.0,
      ...
      "officialStandards": [
        ...
        {
          "code": "D6-4",
          "label": "交通法規之遵守｜未遵守道路交通法規或道路交通標誌、標線、號誌行車",
          "deduction": 32,
          "page": 2
        }
      ],
    ...
    },
    {
      ...
      "answerText": "到號誌路口左轉前，顯示左方向燈並減速查看路口安全",
      "operationText": "到號誌路口左轉前，顯示左方向燈並減速查看路口安全",
      "spokenText": "前方路口減速查看／左右無來車",
      "spokenItems": [
        "前方路口減速查看",
        "左右無來車"
    ...
    },
    {
      ...
      "answerText": "紅燈停等後重新起駛前，先轉頭確認照後鏡與前後左右安全",
      "operationText": "紅燈停等後重新起駛前，先轉頭確認照後鏡與前後左右安全",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "號誌路口"
      ...
      "officialStandards": [
        {
          "code": "D2-3",
          "label": "交岔路口｜起駛前未轉頭察看照後鏡並注意有無障礙或車輛行人",
          "deduction": 32,
          "page": 1
        }
      ],
    ...
    },
    {
      ...
      "answerText": "起駛前確認左右與後方安全後再完成左轉",
      "operationText": "起駛前確認左右與後方安全後再完成左轉",
      "spokenText": "左右無來車，後方無來車",
      "spokenItems": [
        "左右無來車，後方無來車"
      ],
      ...
      "reminderNotes": [
        "教練用B柱提醒你做出明顯轉頭；官方交岔路口主準是起駛前察看照後鏡並注意人車。"
      ],
      "startSec": 555.584,
      "endSec": 565.729,
      "clipLeadSeconds": 1.0,
    ...
    },
    {
      ...
      "answerText": "左轉後依規定進入慢車道",
      "operationText": "左轉後依規定進入慢車道",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "slow_lane",
    ...
    },
    {
      ...
      "answerText": "左轉後持續注意左側與左後方車流，避免影響優先車流",
      "operationText": "左轉後持續注意左側與左後方車流，避免影響優先車流",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "左後方確認"
    ...
    },
    {
      ...
      "captionText": "【前方路口減速查看】【左右無來車】",
      "referenceCaption": "【前方路口減速查看】【左右無來車】",
      "answerText": "返回終點前通過路口先減速查看，確認安全後再通行",
      "operationText": "返回終點前通過路口先減速查看，確認安全後再通行",
      "spokenText": "前方路口減速查看／左右無來車",
      "spokenItems": [
        "前方路口減速查看",
        "左右無來車"
    ...
    },
    {
      ...
      "answerText": "接近終點前保持不壓路面邊線，並減速查看路口安全",
      "operationText": "接近終點前保持不壓路面邊線，並減速查看路口安全",
      "spokenText": "前方路口減速查看／左右無來車",
      "spokenItems": [
        "前方路口減速查看",
        "左右無來車"
    ...
    },
    {
      ...
      "answerText": "靠終點區域前顯示右方向燈並確認左右與後方安全",
      "operationText": "靠終點區域前顯示右方向燈並確認左右與後方安全",
    ...
    },
    {
      ...
      "answerText": "需要再調整位置時依規定顯示左方向燈並確認左右與後方安全",
      "operationText": "需要再調整位置時依規定顯示左方向燈並確認左右與後方安全",
    ...
    },
    {
      ...
      "answerText": "最終靠位前依規定顯示右方向燈並確認安全",
      "operationText": "最終靠位前依規定顯示右方向燈並確認安全",
    ...
    },
    {
      ...
      "answerText": "依考驗員指定完成終點停車，將車輛停正",
      "operationText": "依考驗員指定完成終點停車，將車輛停正",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "起終點停車"
      ...
      "officialStandards": [
        {
          "code": "D7-9",
          "label": "全程道路行駛｜考驗終點停車後下車前未熄火或未拉緊手煞車（自排車未排入P檔）",
          "deduction": 16,
          "page": 2
        }
      ],
    ...
    },
    {
      ...
      "answerText": "考驗終點停車後，依序排入P檔、拉緊手煞車並熄火",
      "operationText": "考驗終點停車後，依序排入P檔、拉緊手煞車並熄火",
      "spokenText": "",
      "spokenItems": [],
      "operationTags": [
        "gear_p",
    ...
    },
    {
      ...
      "answerText": "下車前解開安全帶並準備二段式開門",
      "operationText": "下車前解開安全帶並準備二段式開門",
      "spokenText": "兩段式開車門",
      "spokenItems": [
        "兩段式開車門"
      ],
    ...
    },
    {
      ...
      "answerText": "下車前先看照後鏡，再確認後方與左右安全後依二段式開門下車",
      "operationText": "下車前先看照後鏡，再確認後方與左右安全後依二段式開門下車",
